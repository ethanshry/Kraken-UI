            ...
            <Space direction="vertical" style={styles.spaceStyle}>
                <Card title="About">
                    <Row>
                        ...
                        environment. The intention is to make use of existing local computing
                        resources for development instead of spinning up and paying for cloud
                        computing. Specific use cases include:
                        <ul>
                    ...
                    <Row>
                        ...
                        <a href="https://github.com/ethanshry/Kraken/tree/master/documentation">
                            here
                        </a>
                        .
                    </Row>
                    ...
                    <Row>
                        {this.state.deploymentStep == 0 && (
                            <Space direction="vertical">
                                ...
                                <Row>
                                    <Text>
                                        The <Text code>shipwreck.toml</Text> file is how the Kraken
                                        App Deployment Platform learns about your application. Think
                                        of it as a <Text code>package.json</Text> or{' '}
                                        <Text code>Cargo.toml</Text>
                                        file for a Kraken app.
                                    </Text>

                                    <Text>
                                        The <Text code>shipwreck.toml</Text> must be named exactly
                                        that, and must be placed at the root of your project's
                                        directory. For a good sanity check, if you can see a file at
                                        <Text
                                            code
                                            // @ts-ignore
                                ...
                                <Row>
                                    <Col span={12} style={{ marginTop: 10, paddingRight: 10 }}>
                                        ...
                                        <Text>
                                            the app section contains data pertaining to your
                                            application overall
                                        </Text>
                                        <List
                                            itemLayout="horizontal"
                                            dataSource={this.shipwreckAppData}
                                            renderItem={item => (
                                                <List.Item>
                                                    <List.Item.Meta
                                                        title={item.title}
                                    ...
                                    <Col span={12} style={{ marginTop: 40 }}>
                                        <div style={this.markdownStyle}>
                                            <ReactMarkdown>{this.exampleAppToml}</ReactMarkdown>
                                        </div>
                                    </Col>
                                </Row>
                                <Row>
                                    ...
                                    <Col span={12} style={{ marginTop: 40 }}>
                                        <div style={this.markdownStyle}>
                                            <ReactMarkdown>{this.exampleConfigToml}</ReactMarkdown>
                                        </div>
                                    </Col>
                                </Row>
                            </Space>
                        ...
                        {this.state.deploymentStep == 1 && (
                            <Space direction="vertical">
                                <Row style={{ marginTop: 10 }}>
                                    <Text>
                                        While the Kraken App Deployment Platform handles the
                                        deployment aspects of your project, it does not currently
                                        avoid conflicts with your deployments. As a result,{' '}
                                        <Text mark>
                                            it is up to you to ensure that no two projects will
                                ...
                                <Row>
                                    <Text strong>
                                        ...
                                        conflict with commonly used ports (i.e. 80, 8080), ports
                                        used by services (i.e. RabbitMQ's 5672/15672, or MySQLs
                                        3306), or the port used by the Kraken App Platform, 8000.
                                    </Text>
                                </Row>
                            </Space>
                        )}
                        {this.state.deploymentStep == 2 && (
                            <Space direction="vertical">
                                <Row style={{ marginTop: 10 }}>
                                    <Text>
                                        To onboard an application to the platform, simply copy the
                                        URL from the address bar of the browser for whatever repo
                                        you want to create a deployment for.
                                    </Text>
                                </Row>
                                <Row>
                                    <Text mark>
                                        DO NOT use the git clone URL for your repository.
                                    </Text>
                                </Row>
                                <Row style={{ marginTop: 10 }}>
                                    <Text>
                                        Then take that URL to the <Text mark>Deployments</Text> tab
                                        of the Kraken App Deployment Platform, and paste it into the{' '}
                                        <Text mark>Git URL for Deployment</Text> field. Then click{' '}
                                        <Text mark>Validate Deployment</Text>, and if that is
                                        succesful, <Text mark>Create Deployment</Text>!
                                    </Text>
                                </Row>
                            </Space>
                        )}
